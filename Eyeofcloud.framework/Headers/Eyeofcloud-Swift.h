...
SWIFT_PROTOCOL("_TtP10Eyeofcloud22BackgroundingCallbacks_")
...
typedef SWIFT_ENUM(NSInteger, EyeofcloudDecideOption, open) {
...
@interface EyeofcloudJSON (SWIFT_EXTENSION(Eyeofcloud))
- (nullable instancetype)initWithPayload:(NSString * _Nonnull)p;
- (nullable instancetype)initWithMap:(NSDictionary<NSString *, id> * _Nonnull)m;
///
/// returns:
...
typedef SWIFT_ENUM(NSInteger, EyeofcloudLogLevel, open) {
...
SWIFT_CLASS("_TtC10Eyeofcloud13ObjcAttribute")
@interface ObjcAttribute : NSObject <EyeofcloudAttribute>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC10Eyeofcloud12ObjcAudience")
@interface ObjcAudience : NSObject <EyeofcloudAudience>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSString * _Nonnull conditions;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10Eyeofcloud9ObjcEvent")
@interface ObjcEvent : NSObject <EyeofcloudEvent>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull experimentIds;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10Eyeofcloud14ObjcExperiment")
@interface ObjcExperiment : NSObject <EyeofcloudExperiment>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly, copy) NSString * _Nonnull audiences;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id <EyeofcloudVariation>> * _Nonnull variationsMap;
...
SWIFT_CLASS("_TtC10Eyeofcloud23ObjcEyeofcloudConfigImp")
@interface ObjcEyeofcloudConfigImp : NSObject <EyeofcloudConfig>
@property (nonatomic, copy) NSString * _Nonnull environmentKey;
@property (nonatomic, copy) NSString * _Nonnull revision;
@property (nonatomic, copy) NSString * _Nonnull sdkKey;
@property (nonatomic, copy) NSDictionary<NSString *, id <EyeofcloudExperiment>> * _Nonnull experimentsMap;
@property (nonatomic, copy) NSDictionary<NSString *, id <EyeofcloudFeature>> * _Nonnull featuresMap;
@property (nonatomic, copy) NSArray<id <EyeofcloudAttribute>> * _Nonnull attributes;
@property (nonatomic, copy) NSArray<id <EyeofcloudAudience>> * _Nonnull audiences;
@property (nonatomic, copy) NSArray<id <EyeofcloudEvent>> * _Nonnull events;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10Eyeofcloud11ObjcFeature")
@interface ObjcFeature : NSObject <EyeofcloudFeature>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly, copy) NSArray<id <EyeofcloudExperiment>> * _Nonnull experimentRules;
@property (nonatomic, readonly, copy) NSArray<id <EyeofcloudExperiment>> * _Nonnull deliveryRules;
...
SWIFT_CLASS("_TtC10Eyeofcloud12ObjcVariable")
@interface ObjcVariable : NSObject <EyeofcloudVariable>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly, copy) NSString * _Nonnull type;
@property (nonatomic, readonly, copy) NSString * _Nonnull value;
...
SWIFT_CLASS("_TtC10Eyeofcloud13ObjcVariation")
@interface ObjcVariation : NSObject <EyeofcloudVariation>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly) BOOL featureEnabled;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id <EyeofcloudVariable>> * _Nonnull variablesMap;
